...
for seed in $(seq 5 9); do
  # multivar --- ETTH 
  python -u ../train.py ETTh1 forecast_multivar --archive forecast_csv --alpha 0.0005 --epochs 20 --kernels 1 2 4 8 16 32 64 128 --max-train-length 201 --batch-size 128 --repr-dims 320 --max-threads 8 --seed ${seed} --eval
  # python -u ../train.py ETTh2 forecast_multivar --archive forecast_csv --alpha 0.0005 --epochs 20 --kernels 1 2 4 8 16 32 64 128 --max-train-length 201 --batch-size 128 --repr-dims 320 --max-threads 8 --seed ${seed} --eval
  # python -u ../train.py ETTm1 forecast_multivar --archive forecast_csv --alpha 0.0005 --epochs 20 --kernels 1 2 4 8 16 32 64 128 --max-train-length 201 --batch-size 128 --repr-dims 320 --max-threads 8 --seed ${seed} --eval
  # python -u ../train.py ETTm2 forecast_multivar --archive forecast_csv --alpha 0.0005 --epochs 20 --kernels 1 2 4 8 16 32 64 128 --max-train-length 201 --batch-size 128 --repr-dims 320 --max-threads 8 --seed ${seed} --eval
